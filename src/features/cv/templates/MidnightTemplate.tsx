...
const s = StyleSheet.create({
  ...
  photo: { width: 70, height: 70, borderRadius: 35, border: "2 solid #38bdf8" },
  sName: {
    fontSize: 12,
  ...
  sMeta: { fontSize: 7, color: "#64748b", marginBottom: 4, lineHeight: 1.5 },
  sSecTitle: {
    fontSize: 7,
    fontFamily: "Helvetica-Bold",
    letterSpacing: 1.2,
  ...
  sLine: { height: 1, backgroundColor: "#1e293b", marginBottom: 7 },
  skillCat: {
    fontSize: 7.5,
    fontFamily: "Helvetica-Bold",
    color: "#e2e8f0",
  ...
  eduPer: { fontSize: 7, color: "#475569", marginBottom: 5 },
  main: { flex: 1, padding: "30 26 24 20" },
  secTitle: {
    fontSize: 7.5,
    fontFamily: "Helvetica-Bold",
    letterSpacing: 1.1,
  ...
  secLine: { height: 1, backgroundColor: "#1e293b", marginBottom: 10 },
  secWrap: { marginBottom: 18 },
  summary: { fontSize: 8.5, color: "#94a3b8", lineHeight: 1.65 },
  expRole: { fontSize: 9.5, fontFamily: "Helvetica-Bold", color: "#f1f5f9" },
  expRow: {
    flexDirection: "row",
    justifyContent: "space-between",
    marginBottom: 1,
  },
  expPeriod: { fontSize: 7.5, color: "#475569" },
  expCo: { fontSize: 8.5, color: "#38bdf8", marginBottom: 3 },
  expDesc: { fontSize: 8, color: "#64748b", lineHeight: 1.55 },
  expItem: { marginBottom: 12 },
});

export function MidnightTemplate({
  cv,
  size,
}: {
  cv: CVData;
