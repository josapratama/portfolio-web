...
const s = StyleSheet.create({
  ...
  sidebar: { width: 190, backgroundColor: "#f97316", padding: "30 14 24 14" },
  photoWrap: { alignItems: "center", marginBottom: 14 },
  photo: { width: 74, height: 74, borderRadius: 37, border: "3 solid #fff7ed" },
  sName: {
    fontSize: 13,
  ...
  sMeta: { fontSize: 7.5, color: "#fff7ed", marginBottom: 4, lineHeight: 1.5 },
  sSecTitle: {
    fontSize: 7,
    fontFamily: "Helvetica-Bold",
    letterSpacing: 1.2,
  ...
  sLine: { height: 1, backgroundColor: "#fdba74", marginBottom: 7 },
  skillCat: {
    fontSize: 7.5,
    fontFamily: "Helvetica-Bold",
    color: "#ffffff",
  ...
  eduSch: { fontSize: 7.5, color: "#fff7ed", marginBottom: 1 },
  eduPer: { fontSize: 7, color: "#fed7aa", marginBottom: 5 },
  main: { flex: 1, padding: "30 28 24 22" },
  secTitle: {
    fontSize: 7.5,
    fontFamily: "Helvetica-Bold",
    letterSpacing: 1.1,
  ...
  secLine: { height: 1.5, backgroundColor: "#ffedd5", marginBottom: 10 },
  ...
  expCo: { fontSize: 8.5, color: "#f97316", marginBottom: 3 },
